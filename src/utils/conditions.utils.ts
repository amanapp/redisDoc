export const Conditions = {
    ...
    "Case 22": {
        ...
        "description":"increase the value by specific amount of an existing field in redis",
    ...
    "Case 23": {
        ...
        "description":"increase the value in float by specific amount of an existing field in redis",
    ...
    "Case 65": {
        ...
        "description":"remove the random value from the set but if you pass count in option remove random numbers equal to count from set",
        "Redis Method": "SPOP",
        "Method": "Patch"
    },
